...
import { getAllCustomersHaveGames, getCustomersHaveGameById, createCustomersHaveGame, updateCustomersHaveGame, deleteCustomersHaveGame, } from "../controllers/customerHasGameController.js";
const router = express.Router();
export default function customersHaveGamesRoutes(dbAdapter) {

...
export const getServicePlatforms = async (req, res) => {
    try {
        ...
        const servicePlatforms = rows.map(row => ({
...
export const createServicePlatform = async (req, res) => {
...
export const deleteServicePlatform = async (req, res) => {
    const { id } = req.body;
